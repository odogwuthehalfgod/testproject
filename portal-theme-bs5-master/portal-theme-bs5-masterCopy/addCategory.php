<?php
  ...
  if(isset($_POST["add_category"])){
    ...
    $insert = $pdo->prepare("insert into category_table (category_name) values (:category_name)");

    $insert->bindParam(":category_name", $cat_name);
            ...
            <div class="col-12 col-md-8">
              <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                  <form class="settings-form"action="addCategory.php" method="post">
                    <div class="mb-3">
                    ...
                    <button type="submit" name="add_category" class="btn app-btn-primary">
                      Create Category
                    </button>
                  </form>
                </div>
