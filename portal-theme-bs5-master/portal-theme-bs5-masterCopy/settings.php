<?php
  ...
  if(isset($_POST["add_product"])){
    ...
    $insert = $pdo->prepare("insert into products_table (product_name,price,description) values (:product_name,:price,:desc)");
          ...
          <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
              ...
              <li class="nav-item has-submenu">
                ...
                <div
                  id="submenu-1"
                  class="collapse submenu submenu-1 show"
                ...
                >
                  <ul class="submenu-list list-unstyled">
                    ...
                    <li class="submenu-item">
                      <a class="submenu-link active" href="settings.html"
                        >Settings</a
                      >
                    </li>
                  </ul>
              ...
              <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                  <form class="settings-form"action="settings.php" method="post">
                    ...
                    <button type="submit" name="add_product" class="btn app-btn-primary">
                      Add Product
                    </button>
                  </form>
                </div>
