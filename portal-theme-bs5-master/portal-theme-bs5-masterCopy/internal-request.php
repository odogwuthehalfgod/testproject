  ...
  ?>
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Internal Requisition</h1>
			    <hr class="mb-4">
	    <!-- My own content -->
		...
		<div class="test">
		  ...
		  <div class="data-table">
			<form action="store-request.php" method="post">
				<table>
					<thead>
						<tr>
							<!-- <th>ID</th> -->
	...
	<script>
		...
		document.querySelector(".submit_req").addEventListener("click", function(e){
			...
			if(document.querySelector(".cur_stk").value <=1){
				alert("Quantity of Item is too low to be issued");
				document.querySelector(".cur_req_qty").value = "";
				document.querySelector(".cur_stk").value ="";
				x.selectedIndex = 12;
				return;
			}
